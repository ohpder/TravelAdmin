...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<form id="routeForm" action="${pageContext.request.contextPath}/category/updateCategory.do" method="post" >
				<!-- 内容区域 -->
				<div class="content-wrapper">
					<!--基础控件-->
					<div class="tab-pane" id="tab-common">
						<div class="row data-type">
							...
							<div class="col-md-12 title">分类名称</div>
							<div class="col-md-12 data">
								<input type="text" class="form-control" placeholder="线路名称" name="cName" value="${category.cName}">
							</div>
