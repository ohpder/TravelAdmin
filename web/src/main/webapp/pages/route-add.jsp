...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<form id="routeForm" action="${pageContext.request.contextPath}/route/saveRoute.do" method="post" enctype="multipart/form-data">
				<!-- 内容区域 -->
				<div class="content-wrapper">
					<!--基础控件-->
					<div class="tab-pane" id="tab-common">
						<div class="row data-type">
							...
							<div class="col-md-4 data">
								<input type="text" class="form-control" placeholder="线路名称" name="rname" value="">
							</div>

							<div class="col-md-2 title">价格</div>
							<div class="col-md-4 data">
								<input type="text" class="form-control" placeholder="价格" name="price" value="">
							</div>
