			...
			<form action="${pageContext.request.contextPath}/user/saveUser.do" method="post">
				<div class="tab-pane" id="tab-common">
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" placeholder="真实姓名" name="name" value="">
						</div>
						...
						<div class="col-md-4 data">
							<div class="input-group date">
								...
								<input type="text" class="form-control pull-right" id="datepicker" name="birthdayStr">
							</div>
						</div>
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" placeholder="手机号码" name="telephone" value="">
						</div>


						<div class="col-md-2 title">邮箱</div>
						<div class="col-md-4 data">
							<input type="email" class="form-control" placeholder="邮箱" name="email" value="">
						</div>
