							...
							<table id="dataList"
								...
								<thead>
									<tr>
										...
										<th class="sorting_desc sorting_desc_disabled">真实姓名</th>
										<th class="sorting">出生日期</th>
										<th class="text-center sorting">性别</th>
									...
									<c:forEach items="${pageInfo.list}" var="user">
										...
										<tr>
											...
											<td class="text-center">
												<button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/orders/findAll.do?uid=${user.uid}'">订单管理</button>
												<button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/user/findUserById.do?uid=${user.uid}'" >编辑</button>
											</td>
										</tr>
									</c:forEach>
								</tbody>
	...
	<script>
		...
		function del(){
			var ids = document.getElementsByName("ids");
				...
				// alert(dd)
				if (confirm("将删除所选用户")){
					location.href="${pageContext.request.contextPath}/user/del.do?"+dd;
				}
